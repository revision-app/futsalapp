...
export function AppShell({ profile, active, children }: AppShellProps) {
  return (
    <div className="min-h-screen pb-20">
      <header className="sticky top-0 z-20 border-b border-primary/20 bg-primary text-white shadow-sm">
        <div className="mx-auto flex h-14 max-w-3xl items-center justify-between px-4">
          ...
          <div className="flex items-center gap-3 text-sm">
            ...
            <form action={signOutAction}>
              <button
                type="submit"
                className="inline-flex h-8 w-8 items-center justify-center rounded-md border border-white/40 text-white/90 transition hover:bg-white/10"
                title="ログアウト"
                aria-label="ログアウト"
              >
